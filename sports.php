...
<html>
	<head>
	  ...
	  <style>
	  	body
	  	{
	  		background: #fff url(images/sports.jpg) ;
...
<?php
	...
	$i =1;
	$file_name = 'data/2017/March/sports.json';
	$data=file_get_contents($file_name);			
	//echo $data."<br>";
	$txt=json_decode($data);
	//echo $txt->news[1]->title.'<br>';*/
   
        $fileCount = count (glob ('data/2017/March/sports/*.jpg'));
	foreach($txt->news as $key)
	{
	   ...
	   echo '<div class="col-md-6 text-center">';
         $newName = 'data/2017/March/sports/' . ( $fileCount) . '.jpg';
